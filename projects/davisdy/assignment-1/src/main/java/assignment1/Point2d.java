...
class Point2d {
	...
	double dy = Math.abs(y / pt.getY());  //Intentional bug. Replace - with /
	...
	Point2d point0 = null;
	return distanceFrom (point0);   //Intentional bug
	//return distanceFrom (new Point2d ( ));  Original code
    }
